...
EVAA = [
    [
        InlineKeyboardButton(text="ᴀᴅᴅ ᴍᴇ ʙᴀʙʏ", url=f"https://t.me/DynamicMusicXBot?startgroup=true"),
    ],
]
...
async def _packkang(app :app,message):  
    ...
    if len(message.command) < 2:
        pack_name =  f'{message.from_user.first_name}_sticker_pack_by_@DynamicMusicXBot'
    else :
